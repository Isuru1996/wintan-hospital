  ...
  <main id="main">
	...
	<form method="post" id="user_form">
		...
		<label>Doctor ID</label>
                <input type="text" name="doctor_id" id="doctor_id" class="form-control" disabled/>
            </div>
            <div class="form-group">
...
<script>
	...
	function load_data()
	{
        ...
        $('#user_form').on('submit',function(event){
            ...
            if(error_first_name!=''||error_last_name!=''||error_gender!=''||error_email!=''||error_phone_number!=''||error_type!=''){
                return false;
            }
            else{
