    ...
    if(isset($_POST['first_name'])){
        ...
        if(empty($_POST['email'])){
            ...
            if($return_array['email_error']==""){
                $return_array['email_error']=$obj->user_email_duplicate_check($email);
            }
        }
        ...
        if($return_array['first_name_error']==""&&$return_array['last_name_error']==""&&$return_array['gender_error']==""&&$return_array['email_error']==""&&$return_array['phone_number_error']==""&&$return_array['password_error']==""&&$return_array['confirm_password_error']==""&&$return_array['agree_error']==""){
            $obj=new crud_operation();
            ...
            $return_array['signup_success']=$obj->add_user($first_name, $last_name, $gender, $email, $phone_number, $password,$added_by);
        }
